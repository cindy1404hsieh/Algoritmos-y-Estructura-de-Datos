...
void recorrido_preorden_rec(nodo_abb_t *raiz,size_t *contador, bool (*funcion)(void *, void *), void *aux, bool* se_sigue)
{
		if (!raiz)
			return;
		if((*se_sigue)){
...
void recorrido_inorden_rec(nodo_abb_t *raiz,size_t *contador, bool (*funcion)(void *, void *), void *aux, bool* se_sigue)
{
		if (!raiz)
			return;
...
void recorrido_postorden_rec(nodo_abb_t *raiz,size_t *contador, bool (*funcion)(void *, void *), void *aux , bool* se_sigue)
{
		if (!raiz)
			return;
